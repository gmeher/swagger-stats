...
swsAPIStats.prototype.countResponse = function (res) {
    ...
    this.promClientMetrics.api_request_total.labels(req.method,req.sws.api_path,res.statusCode,t).inc();

    this.promClientMetrics.api_request_duration_milliseconds.labels(req.method,req.sws.api_path,res.statusCode,t).observe(req.sws.duration);
    this.promClientMetrics.api_request_size_bytes.labels(req.method,req.sws.api_path,res.statusCode,t).observe(req.sws.req_clength);
    this.promClientMetrics.api_response_size_bytes.labels(req.method,req.sws.api_path,res.statusCode,t).observe(req.sws.res_clength);
